...
def parse_agrs():
    ...
    parser.add_argument('--lr_ve', type=float, default=0.0005, help='the learning rate for the visual extractor.')
    parser.add_argument('--lr_ed', type=float, default=0.0005, help='the learning rate for the remaining parameters.') #originally 1e-4
...
def main():
    ...
    tester = SurrogateTester(model, criterion, metrics, args, surrogate_dataloader)
    tester.test()
    #print(tester)
