...
def parse_agrs():
    ...
    parser.add_argument('--early_stop', type=int, default=30, help='the patience of training.')

    # Optimization
    parser.add_argument('--optim', type=str, default='Adam', help='the type of the optimizer.')
    parser.add_argument('--lr_ve', type=float, default=1e-5, help='the learning rate for the visual extractor.')
    parser.add_argument('--lr_ed', type=float, default=1e-5, help='the learning rate for the remaining parameters.') #originally 1e-4
...
def main():
    ...
    model_tuner = R2GenModel(args, tokenizer)
    # print(model_tuner)
    ...
    optimizer = build_optimizer(args, model_tuner)
    lr_scheduler = build_lr_scheduler(args, optimizer)

    # build trainer and start to train
    tuner = FineTuner(model_tuner, criterion, metrics, optimizer, args, lr_scheduler, 
